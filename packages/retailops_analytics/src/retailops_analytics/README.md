# retailops_analytics Source Package

Provides a minimal package entry point for analytics distribution metadata and typed imports.
...
- `__init__.py` — Exports analytics-oriented package metadata for dashboarding and business reporting capabilities.
