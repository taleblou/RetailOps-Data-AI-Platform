# retailops_ingestion Source Package

Provides a minimal package entry point for ingestion distribution metadata and typed imports.
...
- `__init__.py` — Exports ingestion package metadata for connector and source-management capabilities.
