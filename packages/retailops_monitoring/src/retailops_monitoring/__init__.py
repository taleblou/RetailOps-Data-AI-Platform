...
# Module:       packages.retailops_monitoring.src.retailops_monitoring
# File:         __init__.py
# Path:         packages/retailops_monitoring/src/retailops_monitoring/__init__.py
#
# Summary:      Exports monitoring package metadata for observability and governance capabilities.
# Purpose:      Provides a minimal package entry point for monitoring distribution metadata and typed imports.
# Scope:        internal
# Status:       stable
#
...
PACKAGE_NAME: Final[str] = "retailops-monitoring"
PACKAGE_ROLE: Final[str] = "monitoring"
