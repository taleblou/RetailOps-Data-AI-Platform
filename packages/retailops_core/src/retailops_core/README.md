# retailops_core Source Package

Provides a minimal package entry point for core distribution metadata and typed imports.
...
- `__init__.py` — Exports core-platform package metadata for shared runtime and orchestration capabilities.
