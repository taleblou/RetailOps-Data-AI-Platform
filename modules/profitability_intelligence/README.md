# Profitability Intelligence Module

Supports the profitability intelligence layer inside the modular repository architecture. Exposes HTTP endpoints for profitability intelligence capabilities.
...
- `main.py` — Provides implementation support for the profitability intelligence workflow.
- `router.py` — Defines API routes for the profitability intelligence module.
- `service.py` — Implements the profitability intelligence service layer and business logic.
- `schemas.py` — Defines schemas for the profitability intelligence data contracts.
- `__init__.py` — Defines the modules.profitability_intelligence package surface and package-level exports.
...
- Key APIs and entry points: main, router, get_profitability_summary, get_profitability_detail, build_profitability_artifact, get_profitability_artifact, get_profitability_sku.
...
- `tests/profitability_intelligence/` automated checks for this module when present
