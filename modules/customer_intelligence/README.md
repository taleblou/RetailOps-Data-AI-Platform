...
Supports the customer intelligence layer inside the modular repository architecture. Exposes HTTP endpoints for customer intelligence capabilities.
...
- `main.py` — Provides implementation support for the customer intelligence workflow.
- `router.py` — Defines API routes for the customer intelligence module.
- `service.py` — Implements the customer intelligence service layer and business logic.
- `schemas.py` — Defines schemas for the customer intelligence data contracts.
- `__init__.py` — Defines the modules.customer_intelligence package surface and package-level exports.
...
- Key APIs and entry points: main, router, get_customer_summary, get_customer_detail, build_customer_intelligence_artifact, get_customer_intelligence_artifact, get_customer_segment.
...
- `tests/customer_intelligence/` automated checks for this module when present
