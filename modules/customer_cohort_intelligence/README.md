# Customer Cohort Intelligence Module

Supports the customer cohort intelligence layer inside the modular repository architecture. Exposes HTTP endpoints for customer cohort intelligence capabilities.
...
- `main.py` — Provides implementation support for the customer cohort intelligence workflow.
- `router.py` — Defines API routes for the customer cohort intelligence module.
- `service.py` — Implements the customer cohort intelligence service layer and business logic.
- `schemas.py` — Defines schemas for the customer cohort intelligence data contracts.
- `__init__.py` — Defines the modules.customer_cohort_intelligence package surface and package-level exports.
...
- Key APIs and entry points: main, router, get_customer_cohort_summary, get_customer_cohort_detail, build_cohort_artifact, get_cohort_artifact, get_cohort_detail.
...
- `tests/customer_cohort_intelligence/` automated checks for this module when present
