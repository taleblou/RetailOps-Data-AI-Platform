# Inventory Aging Intelligence Module

Supports the inventory aging intelligence layer inside the modular repository architecture. Exposes HTTP endpoints for inventory aging intelligence capabilities.
...
- `main.py` — Provides implementation support for the inventory aging intelligence workflow.
- `router.py` — Defines API routes for the inventory aging intelligence module.
- `service.py` — Implements the inventory aging intelligence service layer and business logic.
- `schemas.py` — Defines schemas for the inventory aging intelligence data contracts.
- `__init__.py` — Defines the modules.inventory_aging_intelligence package surface and package-level exports.
...
- Key APIs and entry points: main, router, get_inventory_aging_summary, get_inventory_aging_detail, build_inventory_aging_artifact, get_inventory_aging_artifact, get_inventory_aging_sku.
...
- `tests/inventory_aging_intelligence/` automated checks for this module when present
