# Promotion Pricing Intelligence Module

Supports the promotion pricing intelligence layer inside the modular repository architecture. Exposes HTTP endpoints for promotion pricing intelligence capabilities.
...
- `main.py` — Provides implementation support for the promotion pricing intelligence workflow.
- `router.py` — Defines API routes for the promotion pricing intelligence module.
- `service.py` — Implements the promotion pricing intelligence service layer and business logic.
- `schemas.py` — Defines schemas for the promotion pricing intelligence data contracts.
- `__init__.py` — Defines the modules.promotion_pricing_intelligence package surface and package-level exports.
...
- Key APIs and entry points: main, router, get_promotion_summary, get_promotion_sku, build_promotion_pricing_artifact, get_promotion_pricing_artifact, get_promotion_pricing_sku.
...
- `tests/promotion_pricing_intelligence/` automated checks for this module when present
