...
Supports the connector bigcommerce layer inside the modular repository architecture. Standardizes external-system interaction for the connector bigcommerce workflow.
...
- `main.py` — Provides implementation support for the connector bigcommerce workflow.
- `connector.py` — Implements adapter logic for the connector bigcommerce integration surface.
- `schemas.py` — Defines schemas for the connector bigcommerce data contracts.
- `__init__.py` — Defines the modules.connector_bigcommerce package surface and package-level exports.
- `Dockerfile` — Container build definition for this component.

## Interfaces and data contracts

- Main types: BigCommerceConnector, BigCommerceConnectorConfig.
...
- Important dependencies: __future__, typing, core.ingestion.base.api_connector, core.ingestion.base.models, modules.connector_bigcommerce.schemas, time, pydantic.
...
- `tests/connector_bigcommerce/` automated checks for this module when present
