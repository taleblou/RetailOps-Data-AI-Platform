...
# File:         schemas.py
# Path:         core/monitoring/schemas.py
#
# Summary:      Defines schemas for the monitoring data contracts.
# Purpose:      Standardizes structured payloads used by the monitoring layer.
# Scope:        internal
# Status:       stable
#
...
#
# Notes:
#   - Main types: MonitoringCheckResponse, MonitoringAlertResponse, MonitoringDashboardMetricResponse, MonitoringOverrideEntryResponse, MonitoringOverrideRequest, MonitoringOverrideSummaryResponse, ...
