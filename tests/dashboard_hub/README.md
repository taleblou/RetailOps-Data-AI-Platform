...
Validates dashboard hub behavior and protects the repository against regressions.
...
- `test_dashboard_hub.py` — Contains automated tests for the dashboard hub workflows and behaviors.

## Interfaces and data contracts

- Main types: this area is centered on functions, configuration, or documentation rather than exported classes.
- Key APIs and entry points: test_dashboard_workspace_routes_return_unified_payload, test_dashboard_workspace_publish_and_html_view.

## Operational notes

- Scope profile: test (1).
- Status profile: stable (1).
- Important dependencies: pathlib, fastapi.testclient, core.api.main, core.ingestion.base.repository.
