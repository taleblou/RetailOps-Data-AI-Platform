# Reorder Engine Tests

Validates reorder engine behavior and protects the repository against regressions.
...
- `test_reorder_engine.py` — Contains automated tests for the reorder engine workflows and behaviors.

## Interfaces and data contracts

- Main types: this area is centered on functions, configuration, or documentation rather than exported classes.
- Key APIs and entry points: test_run_reorder_engine_builds_ranked_recommendations, test_get_reorder_recommendation_reads_saved_artifact, test_reorder_router_returns_recommendation_list_and_detail.
