...
Validates analytics behavior and protects the repository against regressions.
...
- `test_kpi_router.py` — Contains automated tests for the analytics workflows and behaviors.

## Interfaces and data contracts

- Main types: this area is centered on functions, configuration, or documentation rather than exported classes.
- Key APIs and entry points: test_kpi_router_is_mounted_on_main_app, test_kpi_get_endpoints_support_json_and_csv.
